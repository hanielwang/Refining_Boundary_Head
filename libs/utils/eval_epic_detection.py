...
class Epicdetection(object):
    ...
    def __init__(self, args, ground_truth_filename=None, prediction_filename=None,
    ...
    def _import_prediction(self, prediction_filename):
        ...
        for videoid, v in data['results'].items():
            if videoid in self.blocked_videos:
                continue
            for result in v:
                if result['action'] not in self.activity_index:
                    continue
                label = self.activity_index[result['action']]
                '''
                ...
                olabel_list.append(result['action'])
    ...
    def print_map(self, args, ap, _type):
        ...
        if self.verbose:
            # print the results
            print('[RESULTS] Action detection results'+'_'+str(_type))
