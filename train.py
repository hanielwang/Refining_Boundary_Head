...
if __name__ == '__main__':
    ...
    parser.add_argument('--gau_sigma', default=3, type=float,
    ...
    parser.add_argument('--sigma3', default=0.5, type=float,
                        help='ratio for combine total loss')
    parser.add_argument('--noun_cls_weight', default=0.5, type=float,
                        help='ratio for combine total loss')
    parser.add_argument('--verb_cls_weight', default=0.5, type=float,
                        help='ratio for combine total loss')
    # parser.add_argument('--action_weight_ratio', default=1, type=float,
    #                     help='ratio for combine total loss')
